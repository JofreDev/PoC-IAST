...
import static co.com.bancolombia.iastpatternconfig.config.utils.FormatUtils.getNumberWithFormat;
...
public class NumericReqJsonValue extends ReqJsonValue {
    ...
    public String getValue(JsonNode jsonNode) {
        ...
        var value =
                optional && valueOfJson.isEmpty() ? valueOfJson : getNumberWithFormat(valueOfJson, format, removeDot);
    ...
    public String getValue(String fieldValue) {
        var value =
                optional && fieldValue.isEmpty() ? fieldValue : getNumberWithFormat(fieldValue, format, removeDot);
        return fillValue(value, this);
    }
}
